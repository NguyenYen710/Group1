...
public final class FragmentBudgetBinding implements ViewBinding {
  ...
  private FragmentBudgetBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivExpensePie,
  ...
  public static FragmentBudgetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBudgetBinding((ConstraintLayout) rootView, ivExpensePie, ll,
